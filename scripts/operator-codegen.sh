...
hack/update-codegen.sh
  mv github.com/Archisman-Mridha/whatsapp-clone/kubernetes/operators/application/pkg/apis/whatsappclone.io/v1alpha1/zz_generated.deepcopy.go pkg/apis/whatsappclone.io/v1alpha1/
  mv github.com/Archisman-Mridha/whatsapp-clone/kubernetes/operators/application/pkg/generated pkg/generated
