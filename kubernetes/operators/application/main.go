...
import (
	...
	"github.com/Archisman-Mridha/whatsapp-clone/kubernetes/operators/application/pkg/controller"
...
func main( ) {
	...
	informer := informerFactory.Whatsappclone( ).V1alpha1( ).Applications( )
