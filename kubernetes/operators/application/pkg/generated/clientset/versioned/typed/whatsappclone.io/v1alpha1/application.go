...
import (
	...
	scheme "github.com/Archisman-Mridha/whatsapp-clone/kubernetes/operators/application/pkg/generated/clientset/versioned/scheme"
...
func newApplications(c *WhatsappcloneV1alpha1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
