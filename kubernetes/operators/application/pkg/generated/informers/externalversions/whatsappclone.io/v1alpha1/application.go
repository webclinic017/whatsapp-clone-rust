...
import (
	...
	whatsappcloneiov1alpha1 "github.com/Archisman-Mridha/whatsapp-clone/kubernetes/operators/application/pkg/apis/whatsappclone.io/v1alpha1"
	versioned "github.com/Archisman-Mridha/whatsapp-clone/kubernetes/operators/application/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/Archisman-Mridha/whatsapp-clone/kubernetes/operators/application/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/Archisman-Mridha/whatsapp-clone/kubernetes/operators/application/pkg/generated/listers/whatsappclone.io/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WhatsappcloneV1alpha1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WhatsappcloneV1alpha1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
		&whatsappcloneiov1alpha1.Application{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&whatsappcloneiov1alpha1.Application{}, f.defaultInformer)
}
